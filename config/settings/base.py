...
ROOT_DIR = environ.Path(__file__) - 3  # (looking_for_group/config/settings/base.py - 3 = looking_for_group/)
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///looking_for_group'),
}
...
MIGRATION_MODULES = {
    'sites': 'looking_for_group.contrib.sites.migrations'
}
