...
urlpatterns = [
    ...
    path(
        "publishers/<slug:publisher>/edit/",
        view=views.GamePublisherUpdateView.as_view(),
        name="pub-edit",
    ),
    path(
        "publishers/<slug:publisher>/delete/",
    ...
    path(
        "systems/<slug:system>/edit/",
        view=views.GameSystemUpdateView.as_view(),
        name="system-edit",
    ),
    path(
        "systems/<slug:system>/delete/",
    ...
    path(
        "publishedmodules/<slug:module>/",
        view=views.PublishedModuleDetailView.as_view(),
        name="module-detail",
    ),
    path(
        "publishedmodules/<slug:module>/edit/",
        view=views.PublishedModuleUpdateView.as_view(),
        name="module-edit",
    ),
    path(
        "publishedmodules/<slug:module>/delete/",
