...
urlpatterns = [
    ...
    path(
        "communities/<uuid:community>/members/<slug:gamer>/kick/",
    ...
    path("communities/<uuid:community>/members/<slug:gamer>/ban/", view=views.CommunityBanUser.as_view(), name='community-ban-gamer'),
